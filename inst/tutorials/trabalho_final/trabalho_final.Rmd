...
pacotes_relatorio <- c("learnr", "knitr", "readxl", "DT", "rmarkdown")
pacotes_usados_relatorio <- listar_pacotes(pacotes_relatorio)

```

Nas funções desenvolvidas neste trabalho, foram usados dos seguintes pacotes: `r pacotes_usados_funcoes`. Além destes, para a elaboração deste relatório também foi utilizado os pacotes `r pacotes_usados_relatorio`.

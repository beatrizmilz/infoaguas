...
# $ codigo_ponto            <chr> "COGR00900", "COGR00900", "COGR00900", "COGR00900", "COGR0090...
...
# $ hora_coleta             <Period> 12H 0M 0S, 12H 0M 0S, 12H 0M 0S, 12H 0M 0S, 12H 0M 0S, 12H...
# $ parametro               <chr> "pH", "pH", "pH", "pH", "pH", "pH", "pH", "pH", "pH", "pH", "...
# $ sinal                   <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, N...
# $ valor                   <chr> "6,40000000", "7,20000000", "6,80000000", "6,50000000", "6,50...
# $ valor_numerico          <dbl> 6.4, 7.2, 6.8, 6.5, 6.5, 6.7, 6.6, 6.9, 6.4, 6.4, 6.8, 5.0, 6...
# $ valor_texto             <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, N...
# $ unidade                 <chr> "U.pH", "U.pH", "U.pH", "U.pH", "U.pH", "U.pH", "U.pH", "U.pH...
...
# $ tipo_de_sistema_hidrico <chr> "Reservatório (Lêntico)", "Reservatório (Lêntico)", "Reservat...
# $ classe                  <chr> "Classe Especial", "Classe Especial", "Classe Especial", "Cla...
...
# $ altitude                <dbl> 865, 865, 865, 865, 865, 865, 865, 865, 865, 865, 865, 865, 8...
...
para exemplificar o uso dos dados obtidos, __será realizada uma comparação dos dados de qualidade da água da Represa Billings com os padrões apresentados na [Resolução CONAMA 357 nº 2005](http://www2.mma.gov.br/port/conama/legiabre.cfm?codlegi=459)__.

Abaixo segue um mapa onde estão apresentados os pontos de coleta na represa Billings:
  ...
  dplyr::mutate(
    ...
    conformidade_conama = dplyr::case_when(
      ...
      parametro == "Clorofila-a" &
        classe == "Classe 4" & valor_numerico <= 60 ~ "Conforme",
      parametro == "Clorofila-a" &
        classe == "Classe 4" & valor_numerico > 60 ~ "Não conforme",
...
billings_conformidade %>% 
  dplyr::count(parametro, ano, data_coleta, conformidade_conama, codigo_ponto) %>% 
  ggplot() +
  geom_col(aes(y = codigo_ponto, x = n, fill = conformidade_conama)) +
